...
function updateGymMarker (item, marker) {
  marker.setIcon('https://imgs.pokemongomap.host/' + gymTypes[item['team_id']] + (item['team_id'] !== 0 ? '_' + getGymLevel(item['gym_points']) : '') + '.png', scaledSize: new google.maps.Size(48, 48)})
